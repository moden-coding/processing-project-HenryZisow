...
public class App extends PApplet {
    ...
    public void setup() { // this method sets up the screen on the startup
        ...
        rectHeight2 = height - rectHeight - random(100, 200); //creates a height based off of the other rectangle to make sure its not too far apart
    ...
    public void draw() { // this method draws everything and updates 60 times per second
        ...
        if (scene == 1) { //main game scene
            ...
            fill(0, 255, 0);
            textSize(60);
            text("Your score was " + score, 200, 500);
            fill(255);
            textSize(45);
            text("Press 'enter' to return to the main menu", 40, 100);
